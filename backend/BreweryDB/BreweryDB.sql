...
INSERT INTO breweries (name, happyHourFrom, happyHourTo,established,address,city,state,zip,siteURL,description,isBar,isBrewery) Values ('Great Lakes Brewing', '04:00', '07:00', 1986, '2516 Market Ave', 'Cleveland', 'OH', 44113, 'www.greatlakesbrewing.com', 'Great Lakes Brewing Company is a brewery and brewpub in Cleveland, Ohio. The first brewpub and microbrewery in the state, Great Lakes Brewing has been noted as important to Cleveland''s local identity and as one of the initial forces behind the revival of the Ohio City neighborhood on Cleveland''s near West Side.', 1, 1) 
INSERT INTO breweries (name, happyHourFrom, happyHourTo,established,address,city,state,zip,siteURL,description,isBar,isBrewery) Values ('Platform Beer Company', null, null, 2014, '4125 Lorain Ave', 'Cleveland', 'OH', 44113, 'www.platformbeerco.com',   'Platform Beer Co. occupies a building that previously housed the Leisy Brewing Company (est. 1873). Platform produces beer for the Northeast Ohio market and is known for its wide variety and often avante-garde style offerings.',1,1)
INSERT INTO breweries  (name, happyHourFrom, happyHourTo,established,address,city,state,zip,siteURL,description,isBar,isBrewery) Values ('Willoughby Brewing Co.', '04:00', '07:00', 1995, '4057 Erie St.', 'Willoughby', 'OH', 44094, 'www.willoughbybrewing.com', 'Nestled in the heart of Historic Downtown Willoughby, Ohio lies Willoughby Brewing Co. Established in February of 1998, we are a full-service restaurant, bar and award-winning brewery in a 100-year-old building that was originally a rail-car repair depot for the Cleveland to Ashtabula Interurban Rail Line.',1,1)
INSERT INTO breweries  (name, happyHourFrom, happyHourTo,established,address,city,state,zip,siteURL,description,isBar,isBrewery) Values ('Sibling Revelry Brewery', null, null, 1995, '29305 Clemens Road', 'Westlake', 'OH', 44145, 'www.siblingrevelrybrewing.com', 'Sibling Revelry Brewing was founded by a family of brothers and cousins from Cleveland who wanted to share their passion for great beer with others. ... Pair beers with a rotating selection of food trucks with great foods like sandwiches, burgers, and more.',1,1)
