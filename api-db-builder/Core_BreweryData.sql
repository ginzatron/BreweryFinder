...
INSERT INTO breweries (name, happyHourFrom, happyHourto, established, address, city, state, zip, latitude, longitude, siteUrl, description, isBar, isBrewery, imgSrc) Values ('BrewNuts', null, null, 2016, '6501 Detroit Ave.', 'Cleveland', 'Ohio', 44102, 41.483894, -81.730469, 'www.brewnutscleveland.com', 'Part bar, part donut shop, this hip Detroit-Shoreway spot pairs beer-based donuts (think Hefeweizen-spiked banana cream, ginger glazed with gooseberry-IPA jam), with craft beer and artisanal coffee.', 1, 0, 'https://gdurl.com/2tnW')
INSERT INTO breweries (name, happyHourFrom, happyHourto, established, address, city, state, zip, latitude, longitude, siteUrl, description, isBar, isBrewery, imgSrc) VALUES ('Moosehead Saloon', '18:00', '21:00', 1994, '694 Dover Center Rd.', 'Westlake', 'Ohio', 44145, 41.476845,-81.921259,'www.mooseheadrestaurant.com', 'Located where Westlake meets Bay, the Moosehead offers a menu of homemade classics paired with local craft beers.',  1, 0, 'https://gdurl.com/2tnW')
...
select * from breweries ORDER BY city, name